...
var Masked = class _Masked {
  ...
  constructor(opts) {
    this._value = "";
    this._update(Object.assign({}, _Masked.DEFAULTS, opts));
  ...
  */
  ...
  typedValueEquals(value) {
    ...
    return value === tval || _Masked.EMPTY_VALUES.includes(value) && _Masked.EMPTY_VALUES.includes(tval) || this.doFormat(value) === this.doFormat(this.typedValue);
  }
};
Masked.DEFAULTS = {
  format: String,
...
var MaskedPattern = class _MaskedPattern extends Masked {
  ...
  constructor() {
    ...
    super(Object.assign({}, _MaskedPattern.DEFAULTS, opts));
  }
  /**
    @override
    @param {Object} opts
...
var MaskedDate = class _MaskedDate extends MaskedPattern {
  ...
  */
  constructor(opts) {
    super(Object.assign({}, _MaskedDate.DEFAULTS, opts));
  }
  /**
    @override
  */
  _update(opts) {
    ...
    opts.blocks = Object.assign({}, _MaskedDate.GET_DEFAULT_BLOCKS());
    if (opts.min)
...
var MaskedNumber = class _MaskedNumber extends Masked {
  ...
  constructor(opts) {
    super(Object.assign({}, _MaskedNumber.DEFAULTS, opts));
  }
  /**
    @override
  */
  ...
  */
  ...
  set typedValue(n) {
    this.rawInputValue = this.doFormat(n).replace(_MaskedNumber.UNMASKED_RADIX, this.radix);
  }
  /** Parsed Number */
  get number() {
    return this.typedValue;
...
var MaskedDynamic = class _MaskedDynamic extends Masked {
  ...
  */
  constructor(opts) {
    super(Object.assign({}, _MaskedDynamic.DEFAULTS, opts));
